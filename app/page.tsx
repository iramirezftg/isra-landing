  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-zinc-100 relative overflow-hidden">
      ...
      <section className="relative max-w-6xl mx-auto px-6 py-32 text-center">
        ...
        >
          Te ayudo a conseguir tu primer empleo en tecnología con estrategia,
          mentoría real y oportunidades concretas.
        </motion.p>
        ...
        >
          <a href="#lead">
            <Button size="lg" className="text-lg px-10 py-7 bg-gradient-to-r from-indigo-500 to-purple-500">
              Quiero el plan gratis
            </Button>
          </a>
          <a href="#coaching">
            <Button size="lg" variant="outline" className="text-lg px-10 py-7 border-zinc-600">
              Ver coaching
            </Button>
          </a>
        </motion.div>
      ...
      <section className="relative h-[220vh]">
        <div className="sticky top-0 h-screen flex items-center justify-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-zinc-300 mb-12">
              junior perdido
            </h2>
      ...
      <section id="lead" className="max-w-4xl mx-auto px-6 py-28">
        <Card className="bg-zinc-900 border border-zinc-700">
          <CardContent className="p-10 text-center">
            <h3 className="text-3xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-400">
              Recurso gratuito
            </h3>
            <p className="text-lg text-zinc-300 mb-8">
              Checklist para conseguir entrevistas tech
            </p>
            <form className="grid md:grid-cols-3 gap-5">
              ...
              <Button className="w-full text-lg py-6 bg-gradient-to-r from-indigo-500 to-purple-500">
                Recibir ahora
              </Button>
            </form>
          </CardContent>
      ...
      <section id="coaching" className="max-w-6xl mx-auto px-6 py-32">
        <h2 className="text-4xl font-bold mb-16 text-center text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
      ...
      <footer className="mt-32 border-t border-zinc-800 py-16 text-center">
        ...
        <p className="text-sm text-zinc-400">
          © {new Date().getFullYear()} isra_developer · Hackea tu futuro
        </p>
      </footer>
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 md:hidden w-[92%]">
        <a href={CALENDLY_URL}>
          <Button className="w-full py-6 text-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            Agenda tu llamada
          </Button>
        </a>
      </div>
